 ...
 *
 * Regenerate automatically once the Supabase CLI is set up:
 *   supabase gen types typescript --project-id dnwdyddwtisqfyxzyiyr > src/types/database.generated.ts
 */
...
// Supabase Database type — matches the shape `supabase gen types typescript`
// produces. Insert/Update are Partial<Row> here — required fields will be
// enforced by Postgres at runtime. This keeps the TS types simple and matches
// what the Supabase client expects.
